...
struct ExerciseListItemVM: Hashable, Equatable {
    let title: String
    ...
    static let shoulderExerciseWithoutStick1: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Podizanje ramena",
    ...
    static let shoulderExerciseWithoutStick2: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Kruženje ramenima",
    ...
    static let shoulderExerciseWithoutStick3: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Kruženje ramenima",
    ...
    static let shoulderExerciseWithoutStick4: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Širenje ruku",
    ...
    static let shoulderExerciseWithoutStick5: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Podizanje ruku",
    ...
    static let shoulderExerciseWithoutStick6: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Istezanje ruku",
    ...
    static let shoulderExerciseWithoutStick7: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Istezanje ruku",
    ...
    static let shoulderExerciseWithStick1: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Podizanje štapa",
    ...
    static let shoulderExerciseWithStick2: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Podizanje štapa",
    ...
    static let shoulderExerciseWithStick3: ExerciseListItemVM = {
        return ExerciseListItemVM(title: "Povlačenje štapa",
